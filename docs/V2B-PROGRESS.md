...
| P5 signal | DONE | pending | vitest 37/37 (reduced-motion still-renders+number, --sev-* parity CSS-hue===SEV_RAMP, mode persists vilmei.risk-mode, compositor law, bins monotonic) · BUILD: dial3d lazy chunk 519.91 kB min / **130.10 kB gzip ≤ 150 kB** · ViewTransitions + spring counter + container-query rail + text-wrap:balance |
