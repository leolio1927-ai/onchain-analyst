...
| P6 machine | DONE | pending | pytest tests/test_mcp.py 10/10 · curl live (tmp port 8123): POST /mcp tools/list 200 + initialize protocolVersion 2026-07-28 200 · GET /.well-known/api-catalog 200 application/linkset+json (RFC 9727) · llms.txt §For AI agents + DocsPage §16 VILMEI FOR AGENTS |
