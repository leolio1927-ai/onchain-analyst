...
| openapi snapshot | DONE | pending | pytest test_contracts snapshot gate green — snapshot regenerated after P3+P6 routes + P7 title; llms.txt §Live API gains rug routes in the same change |
