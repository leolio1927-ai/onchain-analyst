...
| P7 brand | DONE | pending | vitest 42/42 · grep 'Terminal Alpha' frontend/src+*.html = 0 (kecuali DocsPage §12 changelog rename line) · grep vilmei.com = 0 · ledger VM-xx display + #ta-xx anchor + #vm-xx alias (RoadmapPage.test) · migration-once alpha.*→vilmei.* preserve+remove (prefs.test 4/4) · OpenAPI info.title VILMEI |
