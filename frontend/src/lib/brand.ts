...
export const BRAND_NAME = 'VILMEI'
export const BRAND_SHORT = 'VILMEI'
...
export const BRAND_LEGAL =
  '© 2026 VILMEI — Built by VILMEI Labs — read-only · NO TRADING · NO CUSTODY · EVIDENCE FIRST · DATA: GECKOTERMINAL + DEXSCREENER'
